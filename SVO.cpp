...
//
//
//template <typename InnerOctantType, typename LeafType>
//SVO<typename InnerOctantType, typename LeafType>::SVO(const uint32_t levels) {
//	this->levels = levels;
//	if (this->levels < 1)
//		this->levels = 1;
//
...
//
//template <typename InnerOctantType, typename LeafType>
//SVO<typename InnerOctantType, typename LeafType>::SVO(const std::string filename) {
...
//
//template <typename InnerOctantType, typename LeafType>
//const InnerOctantType* const SVO<typename InnerOctantType, typename LeafType>::getInnerOctantData() const {
//	return octantVector.data();
//}
//
//template <typename InnerOctantType, typename LeafType>
//const uint32_t SVO<typename InnerOctantType, typename LeafType>::getInnerOctantsSize() const {
...
//
//template <typename InnerOctantType, typename LeafType>
//void SVO<typename InnerOctantType, typename LeafType>::setInnerOctantsSize(const uint32_t size) {
//	try {
...
//
//template <typename InnerOctantType, typename LeafType>
//void SVO<typename InnerOctantType, typename LeafType>::reserveInnerOctants(const uint32_t size) {
//	try {
...
//
//template <typename InnerOctantType, typename LeafType>
//const LeafType* const SVO<typename InnerOctantType, typename LeafType>::getLeafData() const {
//	return leafVector.data();
//}
//
//template <typename InnerOctantType, typename LeafType>
//const uint32_t SVO<typename InnerOctantType, typename LeafType>::getLeavesSize() const {
//	return leafVector.size() * sizeof(LeafType);
//}
//
//template <typename InnerOctantType, typename LeafType>
//void SVO<typename InnerOctantType, typename LeafType>::setLeavesSize(const uint32_t size) {
//	try {
...
//
//template <typename InnerOctantType, typename LeafType>
//void SVO<typename InnerOctantType, typename LeafType>::reserveLeaves(const uint32_t size) {
//	try {
...
//
//template <typename InnerOctantType, typename LeafType>
//void SVO<typename InnerOctantType, typename LeafType>::addElement(const glm::ivec3 coord, const uint32_t color, const uint32_t normal) {
...
//
//template <typename InnerOctantType, typename LeafType>
//void SVO<typename InnerOctantType, typename LeafType>::printTree(bool verbose) {
...
//
//template <typename InnerOctantType, typename LeafType>
//void SVO<typename InnerOctantType, typename LeafType>::save(const std::string filename) {
